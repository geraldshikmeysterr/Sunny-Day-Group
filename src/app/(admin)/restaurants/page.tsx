        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-card-lg w-full max-w-lg">
            ...
            <div className="flex justify-end gap-2 px-6 py-4 border-t border-neutral-200">
              ...
              <button onClick={save} disabled={saving||!form.name||!form.address} className="btn-primary btn-md">{saving&&<Loader2 size={14} className="animate-spin"/>} Сохранить</button>
            </div>
          </div>
        </div>
      )}
